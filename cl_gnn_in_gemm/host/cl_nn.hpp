...
float interaction_cat(cl_command_queue queue, int term_w, int term_h, int sender_w, int sender_h,
	int receiver_w, int receiver_h, int ri_w, int ri_h, cl_mem sender, cl_mem receiver, cl_mem ri, cl_mem out)
{
	auto start = high_resolution_clock::now();
...
float aggregate_cat(cl_command_queue queue, cl_mem obj_t, cl_mem effect_receiver, cl_mem out,
	int obj_t_w, int obj_t_h, int effect_receiver_w, int effect_receiver_h)
{
	auto start = high_resolution_clock::now();
